...
//	Helper: Map page to pageResponseDTO
	...
	public OrderResponseDTO cancelOrder(Long orderId, String reason) {
	    ...
	    String notes = order.getNotes() != null
	            ? order.getNotes() + "\n"
	            : "";

	    order.setNotes(
	            notes + "[" + LocalDateTime.now() + "] Cancelled: " + reason
	    );
